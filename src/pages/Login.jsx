    ...
    <div className="h-full flex flex-col items-center justify-center gap-[24px] max-w-[720px] mx-auto">
      {!localUserStream && !modelsLoaded && (
        <h2 className="text-center text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
          <span className="block">
          Você está tentando fazer login com seu rosto.
          </span>
          <span className="block text-indigo-600 mt-2">Carregando...</span>
        </h2>
      )}
      {!localUserStream && modelsLoaded && (
        <h2 className="text-center text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
          <span className="block text-indigo-600 mt-2">
          Reconheça seu rosto para fazer login completamente.
          </span>
        </h2>
      )}
      {localUserStream && loginResult === "SUCCESS" && (
        <h2 className="text-center text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
          <span className="block text-indigo-600 mt-2">
          Reconhecemos seu rosto com sucesso!
          </span>
          <span className="block text-indigo-600 mt-2">
          Por favor fique {counter} mais segundos...
          </span>
        </h2>
      )}
      {localUserStream && loginResult === "FAILED" && (
        <h2 className="text-center text-3xl font-extrabold tracking-tight text-rose-700 sm:text-4xl">
          <span className="block mt-[56px]">
            Ups! Não reconhecemos seu rosto.
          </span>
        </h2>
      )}
      {localUserStream && !faceApiLoaded && loginResult === "PENDING" && (
        <h2 className="text-center text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
          <span className="block mt-[56px]">Digitalizando rosto...</span>
        </h2>
      )}
            ...
            {modelsLoaded ? (
              ...
              <>
                ...
                >
                  ...
                  Aguarde enquanto os modelos carregam...
                </button>
              </>
            )}
          </>
