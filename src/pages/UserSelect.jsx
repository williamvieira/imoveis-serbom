...
function UserSelect() {
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center gap-[24px] w-full max-w-[720px] mx-auto">
      <h1 className="text-2xl font-semibold">Selecione um usuário fictício para fazer login</h1>
      <div className="w-full p-4 text-right">
        <div className="mx-auto w-full max-w-md">
          <RadioGroup value={selected} onChange={setSelected}>
            <RadioGroup.Label className="sr-only">Tamanho do servidor</RadioGroup.Label>
            ...
            <div className="flex flex-col items-center justify-center w-full mt-3">
              ...
              >
                <div className="flex flex-col items-center justify-center py-4">
                  ...
                  Clique para fazer upload da imagem de referência
                  </p>
